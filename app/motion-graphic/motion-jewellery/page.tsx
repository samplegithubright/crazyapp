...
const items = [
  { id: 1, title: "Valentine Background", img: "/ai.jpeg", category: "Diamond",link: "/login" },
  { id: 2, title: "Nature Tree", img: "/images/bg2.jpg", category: "Gold",link: "/login" },
  { id: 3, title: "Stock Market", img: "/images/bg3.jpg", category: "Gold",link: "/login" },
  { id: 4, title: "Fire Particles", img: "/images/bg4.jpg", category: "Silver",link: "/login" },
  { id: 5, title: "Confetti", img: "/images/bg5.jpg", category: "Silver",link: "/login" },
  { id: 6, title: "Light Streaks", img: "/images/bg6.jpg", category: "Bridal Jewellery",link: "/login" },
];
...
/>
      ...
      <div className="max-w-6xl mx-auto mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">
          Motion Graphic <span className="text-purple-600">Jewellery</span>
        </h1>
      </div>
