...
export default function VideoTemplates() {
  ...
  // ✅ Fetch Data
  useEffect(() => {
    fetch("/api/media?category=graphics") // 👉 change if needed
      .then((res) => res.json())
      .then((res) => {
        setData(res);
        setLoading(false);
            ...
            filteredItems.map((item) => (
              ...
              >
                ...
                <div className="relative overflow-hidden">
                  ...
                  {/* OVERLAY */}
                  <div className="absolute inset-0 bg-linear-to-t from-black/50 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition duration-300"></div>
